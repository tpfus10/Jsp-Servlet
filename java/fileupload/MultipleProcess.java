...
public class MultipleProcess extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		try {
			...
			for(String originaleFileName : listFileName) {
				String savedFileName = FileUtil.renameFile(saveDirectory, originaleFileName);
				insertMyFile(req, originaleFileName, savedFileName);
			}
