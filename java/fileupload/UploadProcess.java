...
public class UploadProcess extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		try {
			String saveDriectory = getServletContext().getRealPath("/Uploads");
			String originalFileName = FileUtil.uploadFile(req, saveDriectory);
			String savedFileName = FileUtil.renameFile(saveDriectory, originalFileName);
