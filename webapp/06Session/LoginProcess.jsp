...
//member 테이블 DAO를 통해 회원 정보 DTO 정보 획득
MemberDAO dao = new MemberDAO(MySQLDriver, MySQLURL, MySQLId, MySQLPwd); //DB에 접근
MemberDTO memberDTO = dao.getMemberDTO(userId, userPwd); //DB에서 회원의 정보에 접근
dao.close();

//로그인 성공 여부에 따른 처리
if(memberDTO.getId() != null) {
	//로그인 성공: 세션 객체에 데이터 저장
